									...
									<div class="wrap-contact-detail">
										<ul>
											<li>
												...
												<p class="contact-txt">Egypt- Giza - 6 October</p>
											</li>
											<li>
												<i class="fa fa-phone" aria-hidden="true"></i>
												<p class="contact-txt">+201024795414</p>
											</li>
											<li>
												<i class="fa fa-envelope" aria-hidden="true"></i>
												<p class="contact-txt">eng.abdelrahman.mohamed.ramy45@gmail.com</p>
											</li>
										</ul>
									</div>
								</div>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-hotline-footer">
										...
										<b class="phone-number">+201024795414</b>
									</div>
								</div>
							</div>
						...
						<div class="back-link-box">
							...
							<div class="back-link-row">
								<ul class="list-back-link" >
									...
									<li><a href="#" class="redirect-back-link" title="Mobiles Samsung">Samsung</a></li>
									<li><a href="#" class="redirect-back-link" title="Mobiles Lenova">Realme</a></li>
									<li><a href="#" class="redirect-back-link" title="Mobiles Lenova">OPPO</a></li>
									<li><a href="#" class="redirect-back-link" title="Mobiles Lenova">Lenovo</a></li>
								</ul>
								...
								<ul class="list-back-link" >
									...
									<li><a href="#" class="redirect-back-link" title="Calling Tablets" >OPPO Tablets</a></li>
									<li><a href="#" class="redirect-back-link" title="Micrumex Tablets" >HUAWEI Tablets</a></li>
									<li><a href="#" class="redirect-back-link" title="Lenova Tablets Bsus" >Lenovo Tablets</a></li>
									<li><a href="#" class="redirect-back-link" title="Tablets iBall" >Tablets IPad</a></li>
									<li><a href="#" class="redirect-back-link" title="Tablets Swipe" >Tablets Realme</a></li>
								</ul>
